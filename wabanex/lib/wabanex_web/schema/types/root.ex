defmodule WabanexWeb.Schema.Types.Root do
  ...
  alias Crudry.Middlewares.TranslateErrors #tratamento de erros
  ...
  object :root_query do
    field :get_user, type: :user do
      ...
      resolve &UserResolver.get/2  #importando função implicitamente de outro módulo
      #mesma coisa poderia ser feita por:  resolve fn params, context -> User.Resolver.get(params, context) end
    end
  end
